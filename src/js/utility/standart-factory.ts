...
export default class StandartFactory implements GUIFactory {
  ...
  get taskCheckBox () {
    return new StandartInput('item__marker-checkbox visually-hidden', 'checkbox').getElem()
  }

  get taskCheckBoxMarker () {
    return new StandartSpanMarker('marker-checkbox checkbox').getElem()
  }
  ...
  get footerRightSection () {
    return new StandartHTMLElement('section', 'todo-footer__total-table').getElem()
  }
  ...
  get footerCompleteBtn () {
    return new StandartButton('sort-task-section__complete-all-button button', 'All complete').getElem()
  }

  get footerRemoveCompleteBtn () {
    return new StandartButton('sort-task-section__remove-comlete-button button', 'Remove comlete').getElem()
  }
